...
- [ ] **保護者さまの声を集める→差し替え** — 実際の声ベース必須（ステマ規制）。**2026-08-12 候補文5本を確定し仮文面としてサイト反映済み**（data/home.ts の voices。軸: 苦手克服/習慣・安心感/遡り学習(受験)/1対4/料金・5教科）。残り: この型に近い実話をアンケートで集めて置き換え→※仮表記を削除（設問案: ①入会前の困りごと ②入会後の変化 ③良いところ1つ ④同じ悩みの保護者へ一言）
