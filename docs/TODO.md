...
- [x] **料金ページ（/price）本文の再設計** — 2026-08-13 完了。3本柱構成（授業料/諸経費/その他オプション）+問い吹き出し。2教科以上=単純合算で実料金確定・※仮削除。他塾比較は現行サイト公開中のデータ（M塾/E塾）に統一（トップPriceも同データに）
...
- [ ] 他塾比較の金額根拠・「当社調べ」表記の確定（トップPrice・/price）※2026-08-13に現行サイト公開中の比較データ（M塾20,400円/E塾27,500円）へ統一済み。公開前に根拠資料（調査元・時点）の社内確認だけ残す
