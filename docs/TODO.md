...
- [ ] **教室の写真差し替え** — 各教室4枚×10教室。`src/assets/classrooms/<slug>/` に置くだけで自動反映（ライトボックスも実写真に自動切替）
  ...
  - [ ] 残り1教室: 都賀（撮影待ち）。**都賀の撮影時に、外観の撮り直しもまとめて対応**（2026-09-17ユーザー決定）: 稲毛海岸01（下の焼肉店のシャッター・提灯が主役になっている）、新検見川01（隣の整骨院のピンク看板が目立つ）、稲毛01（木が看板を隠す）、四街道01（看板が小さく建物が無地に見える）。塾の看板が読める角度で
