...
- [ ] **教室の写真差し替え** — 各教室4枚×10教室。`src/assets/classrooms/<slug>/` に置くだけで自動反映（ライトボックスも実写真に自動切替）
  - [x] 2026-09-16 4教室投入: 妙典・新検見川・稲毛海岸・稲毛（2026-09-04撮影分・各4枚=教室内3＋外観1。幅2000px/品質85にリサイズして配置）。**妙典はLightroom現像済みの正式版**（`~/Downloads/2026-09-16/myoden_pic1〜4.jpg`・01=外観）。**他3教室はカメラJPEG（`~/Pictures/2026/2026-09-04/DSC*.JPG`）の仮投入**→現像済み版が書き出されたら同じ手順で差し替える。投入時に実写真タイルが縦長に崩れる不具合（`<Image>`の height 属性で aspect-ratio が無効化）を PhotoGallery.astro の `height:auto` で修正
  - [ ] 残り6教室: 西千葉・都賀・蘇我・鎌取・四街道・五井（撮影待ち）
