...
export const questions: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { label: '時間にしばられない通いやすさ', s: [2, 0, 0, 0, 1] },
    ],
  },
];
...
export const types: Record<string, DiagnosisType> = {
  ...
  B: {
    ...
    note: '集団塾の授業は、どんどん先へ進んでいきます。授業についていけなくなったときは、フォーカス（個別指導）との併用も可能です。',
  },
  C: {
  ...
  E: {
    ...
    points: ['「教わりながら、自分で解く力もつけたい」お子さま向け', '必要なときにサポートが受けられるので、主体的に学ぶ習慣がつく', '個別指導のなかでは授業料が抑えめ。金額面で個別をあきらめていたご家庭にも手が届く'],
  },
};
