...
export const leadForms: Record<LeadFormVariant, LeadFormCopy> = {
  request: {
    ...
    // 誤番号だと第三者にSMSが届くため強めに確認を促す
    phoneConfirmNote: '※この番号宛てに資料のURLをSMSでお送りします。お間違いがないかご確認ください',
    submitLabel: '資料を受け取る',
    doneTitle: '送信しました',
    // lead-api が資料請求の直後にパンフレットURLをSMS自動送付する（楽天CPaaS）。届かない場合の案内も添える
    doneBody: 'お申し込みを受け付けました。ご入力いただいた携帯電話番号あてに、資料のURLをSMSでお送りしました。数分たっても届かない場合は、お手数ですがお近くの教室までご連絡ください。',
    theme: 'orange',
  },
  consult: {
